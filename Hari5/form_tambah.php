    ...
    <form action="controller/tambah.php" method="post">
        <table align="center" style="margin-top:50px">
            <tr>
                ...
                <td>:</td>
                <td><input type="number" name="nim" id="nim" placeholder="NIM MAHASISWA"></td>
            </tr>
            <tr>
                <td><label for="nama">Nama Mahasiswa</label></td>
                <td>:</td>
                <td><input type="text" name="nama" id="nama" placeholder="NAMA MAHASISWA"></td>
            </tr>
            <tr>
                <td><label for="jenis">Jenis Kelamin</label></td>
                <td>:</td>
                <td><input type="radio" name="jenis" id="jenis" value="Laki-Laki">Laki-Laki
                    <input type="radio" name="jenis" id="jenis" value="perempuan">Perempuan </td>
            </tr>
            <tr>
